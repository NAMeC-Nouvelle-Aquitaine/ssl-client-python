...
class FieldObserver:
    @classmethod
    def guess_goal_keeper(cls, robots: list[ClientRobot], goal_posts: np.array):
        """
    ...
    @classmethod
    def highest_gap_from_posts(cls, gk: ClientRobot, goal_posts: np.array):
        """
        ...
        wanted_post = np.maximum(*gk_dists_from_posts)
        return wanted_post
